...
//     inviteResult.updateInviteResultListCommentsCount(props.userId)
//   }
//   catch (error) {
//     console.error({ error })
...
async function deleteBlackListById() {
  ...
  try {
    ...
    banResultStore.deleteInviteResult(props.userId)
    // banResultStore.updateInviteResultList(props.userId, { isLocked: false })
  }
  catch (error) {
    console.error({ error })
