...
async function unlockComment() {
  ...
  try {
    ...
    collectionsResult.updateInviteResultList(props.userId, { isUnlock: true })
  }
  catch (error) {
    console.error({ error })
...
async function deleteBlackListById() {
  ...
  try {
    ...
    collectionsResult.updateInviteResultList(props.userId, { isLocked: false })
  }
  catch (error) {
    console.error({ error })
...
async function postBlackList() {
  ...
  try {
    ...
    collectionsResult.updateInviteResultList(props.userId, { isLocked: true })
  }
  catch (error) {
    console.error({ error })
