...
async function clickHandler() {
  ...
  try {
    await collectionApi.deleteCollectionById(tempCollectionTableId.value)
    toastMessage.value = '移除收藏成功'
    toastType.value = 'success'

    collectionsResult.deleteInviteResult(tempCollectionTableId.value)
  }
  catch (error) {
    console.error(error)
